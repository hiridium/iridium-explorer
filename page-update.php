<?php
	...
	if (@$_POST['updateasset']) {
		if (!no_displayed_error_result($listassets, iridiun('listassets', $_POST['issuetxid'], true)))
			return;
		...
		$success=no_displayed_error_result($issuetxid, iridiun('createrawsendfrom', $from, $addresses, $datas, 'send'));
...
<?php
	if (no_displayed_error_result($listassets, iridiun('listassets', '*', true))) {
