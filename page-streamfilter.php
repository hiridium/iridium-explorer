<?php
	...
	if (@$_POST['teststreamfiltercode']) {
		if (no_displayed_error_result($teststreamfilter, iridiun('teststreamfilter', false, $_POST['code']))) {
	...
	if (@$_POST['teststreamfilterpublish']) {
		...
		if (isset($data) && no_displayed_error_result($createrawsendfrom, iridiun('createrawsendfrom',
			...
			if (no_displayed_error_result($teststreamfilter, iridiun_with_raw(
	...
	if (no_displayed_error_result($liststreams, iridiun('liststreams', '*', true)))
	...
	if (no_displayed_error_result($getaddresses, iridiun('getaddresses', true))) {
		...
		if (no_displayed_error_result($listpermissions,
			iridiun('listpermissions', 'create', implode(',', array_get_column($getaddresses, 'address')))
		))
...
<?php
	if (no_displayed_error_result($liststreamfilters, iridiun('liststreamfilters', '*', true))) {
