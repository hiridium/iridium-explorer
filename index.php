<?php
	...
	set_iridiun_chain(@$config[$chain]);
...
<style type="text/css">
	#imgpos {
		...
		<a href="http://192.168.0.25/iridium-web"><img src="https://i.ibb.co/k4Kr3bH/logo2.png" alt="logo2" width="100" height="100" border="0" id="imgpos" /></a>
	...
	<body>
		<div class="container">
			<h1><a href="./">IRIDIUM WEB BLOCKCHAIN</a><?php if (strlen($name)) { ?> &ndash; <?php echo html($name)?><?php } ?></h1>
<?php
	if (strlen($chain)) {
		$name=@$config[$chain]['name'];
?>
